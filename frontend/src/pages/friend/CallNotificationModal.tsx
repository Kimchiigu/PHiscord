...
const CallNotificationModal: React.FC<CallNotificationModalProps> = ({ callerName, onAccept, onDecline }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-[--primary-bg-color] p-4 rounded-lg text-center">
        <p className="text-[--primary-text-color] text-lg mb-4">{callerName} is calling you. Do you want to accept?</p>
