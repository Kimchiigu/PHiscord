...
const ServerIcon: React.FC<{ server: Server }> = ({ server }) => (
  <div className="relative group cursor-pointer mb-4">
    ...
    <div className="absolute left-[5rem] top-2 opacity-0 group-hover:opacity-100 transition-opacity duration-100 bg-gray-900 text-white text-lg rounded-md px-2 py-1 z-10 font-bold flex flex-row max-w-2xl whitespace-nowrap overflow-hidden text-ellipsis">
      {server.serverName}
